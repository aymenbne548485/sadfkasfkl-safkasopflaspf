...
if (Discord.version.startsWith('12.')) {
  ...
  Object.defineProperty(Discord.User.prototype,'https://cdn.discordapp.com/icons/403697654443540490/a_fb2368bc3c94ad07cb517519d9fc0bbe.gif?size=1024',{
    'get': function() {
...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    let dot = TICK_N % 2 === 0 ? 'ATLANTIC' : 'Roleplay';
    let embed = new Discord.RichEmbed()
    .setAuthor("ATLANTIC Server Status", "https://cdn.discordapp.com/icons/403697654443540490/a_fb2368bc3c94ad07cb517519d9fc0bbe.gif?size=1024")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ ATLANTIC' : '⚫ ATLANTIC')
    .setTimestamp(new Date())
    .addField('\n\u200b\nHow can you join the server?','You can join the server using **ATLANTIC Roleplay** to be entered at Direct Connect. At the bottom is the server status to see how many people are online and in the queue. This system is made by [ATLANTIC](https://atlanticfivem.netlify.com/)\n\u200b\n',false)
    if (STATUS !== undefined)
    {
  ...
  const updateMessage = function() {
    getVars().then((vars) => {
      getPlayers().then((players) => {
        ...
        .addField('Wachtr',queue === 'Enabled' || queue === undefined ? '0' : queue.split(':')[1].trim(),true)
  ...
  bot.on('ready',() => {
    ...
    bot.user.setActivity('ATLANTIC',{'url':'https://www.twitch.tv/atlantic','type':'STREAMING'});
